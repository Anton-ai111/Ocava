...
<head>
    <title><?php echo "Hashtag - ".$_GET['tag'];if($_GET['tag'] == 'search'){echo "Hashtag";} ?> | Ocava</title>
    <meta charset="UTF-8">
    ...
    <meta name="keywords" content="hashtag,social network,social media,Ocava,meet,free platform">
